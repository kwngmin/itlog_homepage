...
export default function GateSystem() {
  return (
    <div className="relative bg-emerald-50 rounded-2xl p-6 sm:p-20 md:px-12 lg:px-16 md:py-16 lg:py-20 lg:my-60 xl:px-20 flex flex-col md:flex-row justify-between md:items-center gap-8 md:gap-24 overflow-hidden">
      <div className="relative flex flex-col md:w-2/3 z-20">
      ...
      <Image
        ...
        width={420}
        height={420}
        className="absolute -top-60 sm:top-1/2 sm:-translate-y-1/2 sm:mt-3 sm:-right-30 md:-right-40 lg:-right-44 xl:-right-40 w-[240px] sm:w-[470px] lg:w-[580px]"
      />
    </div>
  );
}