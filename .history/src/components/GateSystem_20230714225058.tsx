...
export default function GateSystem() {
  return (
    <div className="relative bg-emerald-50 rounded-2xl p-6 sm:py-20 md:px-12 lg:px-16 md:py-16 lg:py-20 xl:px-20 my-60 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-24 overflow-hidden">
