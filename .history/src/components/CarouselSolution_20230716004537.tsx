...
export default function CarouselSolution() {
  return (
    <div className="my-20">
      ...
      <p className="break-keep sm:w-9/12 sm:bg-yellow-100 lg:w-4/6 tracking-tight text-lg sm:text-xl mt-2 leading-relaxed sm:leading-normal text-black/60 font-medium">
