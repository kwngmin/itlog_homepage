...
export default function GateSystem() {
  return (
    <div className="relative bg-emerald-50 rounded-2xl p-6 sm:p-20 md:px-12 lg:px-16 md:py-16 lg:py-20 lg:my-60 xl:px-20 flex flex-col md:flex-row justify-between lg:items-center gap-8 md:gap-24 overflow-hidden">
