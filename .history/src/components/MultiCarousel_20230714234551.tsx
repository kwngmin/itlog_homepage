...
export default function MultiCarousel() {
  return (
    <>
      ...
      <div className="hidden lg:flex py-4 md:py-8 my-4  bg-gray-50 rounded-2xl gap-2 sm:gap-3 md:gap-4">
        <div className="relative overflow-hidden w-20 rounded-r-2xl bg-gradient-to-b from-slate-800 to-blue-800 drop-shadow-xl" />
        <div className="relative  bg-black rounded-2xl overflow-hidden h-72 flex flex-col justify-center drop-shadow-xl">
          <Image
            alt="itlog Logo"
            src={"/images/sideFace.png"}
            width={640}
        ...
        <div className="relative overflow-hidden w-20 rounded-l-2xl bg-gradient-to-b from-cyan-800 to-slate-800 drop-shadow-xl" />
      </div>
