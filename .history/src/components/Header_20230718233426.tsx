    ...
    <>
        ...
        <div className="flex items-center pl-2 pr-4 sm:px-6 md:px-10 xl:px-8 w-[1536px] justify-between h-[72px] relative">
          <div className="flex items-center">
            <button
              ...
              } sm:hidden w-12 h-12 mr-3 flex items-center justify-center rounded-xl select-none text-2xl`}
            >
      ...
      {foldStatus && (
        <section className="sm:hidden">
          <div className="absolute flex flex-col px-3 pt-8 pb-12 w-full grow top-[72px] bg-gray-100 z-40 gap-6 overflow-y-auto">
            <IntroCompany
