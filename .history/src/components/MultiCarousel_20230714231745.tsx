...
export default function MultiCarousel() {
  return (
    <>
      ...
      <div className="hidden lg:flex py-4 md:py-8 my-4  bg-slate-100 rounded-2xl gap-2 sm:gap-3 md:gap-4">
        <div className="relative overflow-hidden w-20 rounded-r-2xl bg-gradient-to-b from-slate-800 to-blue-800" />
        <div className="relative  bg-black rounded-2xl overflow-hidden h-72 flex flex-col justify-center">
          <Image
            ...
            className="absolute -right-40 object-cover z-20 mix-blend-lighten h-full"
          />
          <div className="relative z-10 mx-2 sm:mx-12 md:ml-16 lg:ml-20">
