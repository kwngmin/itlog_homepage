      ...
      <ul className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-black/70">
        <li className="flex items-center">
          <div className="flex justify-center bg-gray-800 text-white font-medium w-8 h-8 rounded-full py-1 mr-2">
            T
          </div><span className='sm:hidden font-medium mr-4'>Tel.</span>
          02-859-2064
        </li>
        <li className="flex items-center">
          <div className="flex justify-center bg-gray-800 text-white font-medium w-8 h-8 rounded-full py-1 mr-2">
            F
          </div><span className='sm:hidden font-medium mr-4'>Fax.</span>
          02-859-2065
        </li>
        <li className="flex items-center">
          <div className="flex justify-center bg-gray-800 text-white font-medium w-8 h-8 rounded-full py-1 mr-2">
            M
          </div><span className='sm:hidden font-medium mr-4'>Mail.</span>
          ok@it-log.co.kr
        </li>
      </ul>
