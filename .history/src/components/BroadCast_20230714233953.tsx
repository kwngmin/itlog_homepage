...
export default function BroadCast() {
  return (
    <div className="relative bg-violet-50 rounded-2xl p-6 sm:p-8 md:p-12 lg:px-16 md:py-16 xl:px-20 my-60 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-24 overflow-hidden">
