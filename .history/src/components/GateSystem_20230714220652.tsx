...
export default function GateSystem() {
  return (
    <div className="relative bg-emerald-50 rounded-2xl p-6 sm:p-8 md:px-12 lg:px-16 md:py-28 xl:px-20 my-60 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-24 overflow-hidden">
      ...
      <Image
        ...
        width={420}
        height={420}
        className="absolute sm:top-10 md:top-1/2 md:-translate-y-1/2 md:mt-3 md:-right-28 lg:-right-16 xl:right-0 w-[240px] sm:w-[320px] md:w-[420px]"
      />
    </div>
  );
}
