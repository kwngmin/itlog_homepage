  ...
  return (
    <div className="relative flex justify-center items-center h-full">
      ...
      <div className="z-10 px-4 md:px-6 xl:px-0 w-[1024px] pb-32 ml-12 sm:ml-20 md:ml-0">
        ...
        <p className="lg:leading-normal xl:leading-normal w-3/4 lg:w-3/5 text-xl sm:text-2xl leading-normal sm:leadeing-normal md:leading-normal tracking-tight lg:tracking-tighter text-black/70 break-keep">
