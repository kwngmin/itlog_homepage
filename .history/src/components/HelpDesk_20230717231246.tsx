      ...
      <ul className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-black/70">
        <li className="flex items-center">
          <div className="flex justify-center bg-gray-800 text-white font-medium w-8 h-8 rounded-full py-1 mr-2">
            T
          </div><span className='sm:hidden font-medium'>전화</span><div className='sm:hidden h-4 mx-2 border-l-2 border-gray-300'/>
          02-859-2064
        </li>
        <li className="flex items-center">
          <div className="flex justify-center bg-gray-800 text-white font-medium w-8 h-8 rounded-full py-1 mr-2">
            F
          </div><span className='sm:hidden font-medium'>팩스</span><div className='sm:hidden h-4 mx-2 border-l-2 border-gray-300'/>
          02-859-2065
        </li>
        <li className="flex items-center">
          <div className="flex justify-center bg-gray-800 text-white font-medium w-8 h-8 rounded-full py-1 mr-2">
            M
          </div><span className='sm:hidden font-medium'>메일</span><div className='sm:hidden h-4 mx-2 border-l-2 border-gray-300'/>
          ok@it-log.co.kr
        </li>
      </ul>
