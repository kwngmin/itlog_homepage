  ...
  return (
    <div className="relative flex justify-center items-center h-full">
      ...
      <div className="z-10 px-4 md:px-6 xl:px-0 w-[1024px] pb-32">
        ...
        <p className="lg:leading-normal xl:leading-normal w-full md:w-3/5 lg:w-3/4 text-lg sm:text-xl md:text-2xl md:leading-normal tracking-tight lg:tracking-tighter text-black/70 break-keep">
