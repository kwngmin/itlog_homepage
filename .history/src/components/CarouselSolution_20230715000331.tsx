...
export default function CarouselSolution() {
  return (
    <div className="my-20">
      ...
      <p className="break-keep w-full md:w-4/6 tracking-tight md:text-lg lg:text-xl mt-2 leading-normal text-black/70 font-medium">
        ...
        <b className="font-medium text-black">
          통합 <strong className="font-medium text-red-500">IoT</strong> 솔루션
        </b>
        을 제공합니다.
      </p>
      <MultiCarousel />
