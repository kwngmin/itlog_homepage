...
export default function Instance() {
  return (
    <div className="my-60">
      ...
      <div className='flex items-center justify-center px-5 h-8 rounded-full ring hover:ring-0 ring-gray-200 font-medium tracking-tighter hover:bg-red-500 hover:text-white'>더 보기</div>
        </div>
