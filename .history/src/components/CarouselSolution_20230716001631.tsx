...
export default function CarouselSolution() {
  return (
    <div className="my-20">
      ...
      <p className="break-keep w-full md:w-5/6 lg:w-4/6 tracking-tight sm:text-lg lg:text-xl mt-2 sm:leading-normal lg:leading-normal text-black/60 font-medium">
