...
export default function GateSystem() {
  return (
    <div className="relative bg-emerald-50 rounded-2xl p-6 sm:py-16 md:px-12 lg:px-16 md:py-16 lg:py-20 xl:px-20 my-60 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-24 overflow-hidden">
      <div className="relative flex flex-col sm:w-4/5 md:w-2/3 z-20">
        ...
        <p className="sm:text-lg sm:leading-normal md:text-xl md:leading-normal tracking-tighter break-keep text-black/70 mb-8 sm:mb-6 lg:mb-16">
          출입통제 시스템은 실시간으로 작업자의 출입 기록을 관리하고, 비인가자의
          출입을 차단함으로써 작업자들의 안전을 보호합니다. 현장의 보안 관리와
          작업자들의 안전까지 예방하고 보호할 수 있습니다.
        </p>
        <div className="flex-none flex lg:hidden gap-4 z-20 pb-6">
        <IconLabel
      ...
      <div className="flex-none hidden lg:flex gap-4 z-20 py-16 md:py-0 sm:py-4 order-first md:order-last">
        <IconLabel
          icon={"/icons/face-id.png"}
          iconLabel={"안면인식 시스템"}
          iconCss={""}
