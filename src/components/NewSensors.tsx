...
export default function NewSensors() {
  return (
    <div className="flex flex-col items-center sm:flex-row justify-between md:items-center gap-6 sm:gap-10 my-60">
      ...
      <div className="relative overflow-hidden rounded-2xl flex items-center justify-center bg-sky-50 w-full sm:w-2/5 aspect-video sm:aspect-square order-first sm:order-last">
