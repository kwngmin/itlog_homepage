...
export default function Solution() {
  return (
    <div className="my-20 p-10 sm:px-12 py-16 rounded-3xl bg-gradient-to-br from-slate-100 to-red-50">
      ...
      <p className="break-keep sm:w-10/12 md:w-11/12 tracking-tighter text-lg sm:text-xl md:text-2xl mt-4 leading-relaxed sm:leading-relaxed md:leading-relaxed text-black/70">
