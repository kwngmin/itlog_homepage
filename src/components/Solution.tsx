...
export default function Solution() {
  return (
    <div className="my-20 p-6 md:px-12 py-16 rounded-2xl bg-gradient-to-br from-slate-100 to-red-50 ">
      ...
      <p className="break-keep md:w-11/12 tracking-tighter text-xl md:text-2xl mt-2 leading-relaxed md:leading-relaxed text-black/70">
