...
export default function Solution() {
  return (
    <div className="my-20 p-8 sm:px-12 py-16 rounded-3xl bg-gradient-to-br from-slate-100 to-red-50">
      ...
      <p className="break-keep w-11/12 sm:w-10/12 tracking-tighter text-lg sm:text-xl md:text-2xl mt-2 leading-relaxed sm:leading-relaxed md:leading-relaxed text-black/70">
